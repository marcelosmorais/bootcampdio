function start() { // Inicio da função start()
	...
	$("#fundoGame").append("<div id='jogador' class='jogador'></div>"); // .append cria um string no html
...
var podeAtirar = true;
var velocidade=5;
var posicaoY = parseInt(Math.random() * 600);
...
//Explos�o 1
	...
	//Reposiciona Inimigo2
		...
		function reposicionaInimigo2() {	
			var tempoColisao4=window.setInterval(reposiciona4, 300);			
		...
		function reposicionaAmigo() {	
			var tempoAmigo=window.setInterval(reposiciona6, 300);			
